...
TwoWaySprite::TwoWaySprite( const std::string& name) : MultiSprite(name),isJumping(0),idleFrames(Gamedata::getInstance().getXmlInt(getName()+"/idleframe")),idleTime(0),idleTimeLimit(Gamedata::getInstance().getXmlInt("idleTimeLimit")) 
{
  setVelocity(Vector2f(0,0));
} 

TwoWaySprite::TwoWaySprite( const TwoWaySprite& t) : MultiSprite(t),isJumping(t.isJumping), idleFrames(Gamedata::getInstance().getXmlInt(getName()+"/idleframe")),idleTime(0),idleTimeLimit(Gamedata::getInstance().getXmlInt("idleTimeLimit")) {} 
